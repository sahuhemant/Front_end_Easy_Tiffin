  ...
  const fetchPaymentData = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:3001/customer_payment_detail`, {
        ...
        body: JSON.stringify({ payment_status: "yes" }) // Sending payment status as "yes"
      });
    ...
    <div className="payment-done-container">
      ...
      <div className="payment-content">
        ...
        {paymentData.length > 0 ? (
          ...
          <div>
            <h1>No Payment Data Available</h1>
            <p>It seems like there is no payment data to show at the moment.</p>
          </div>
        )}
      </div>
    </div>
